...
const Footer = () => (
  <footer className="w-full bg-[#c9a063] text-white py-10 font-[Optima] mt-0">
    <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
      {/* Contact Info - Left */}
      <div className="flex flex-col items-center md:items-start gap-2 md:w-1/3 order-2 md:order-2 text-center md:text-left" style={{marginLeft: '-8rem'}} >
      ...
      {/* Quick Links - Right */}
      <div className="flex flex-col items-center md:items-end gap-2 md:w-1/3 order-9 text-center md:text-right ">
