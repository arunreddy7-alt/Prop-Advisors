...
const ProjectShriRamGharunda = () => (
  <section id="shriramgharunda" className="w-full bg-white py-20 font-[Optima] scroll-mt-24">
      ...
      <div className="flex flex-col md:flex-row-reverse items-center gap-12">
        ...
        <div className="flex-1 w-full md:w-1/2 text-center md:text-left mt-12">
          ...
          <div className="flex flex-row gap-4 mt-4">
            ...
            <a href="#contact-form" className="bg-[#b68a5e] text-white px-6 py-3 rounded font-bold text-base shadow hover:bg-[#a67c52] transition">Enquire</a>
          </div>
        </div>
      </div>
    </div>
